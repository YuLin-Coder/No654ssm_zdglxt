...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>销售明细管理 <span class="c-gray en">&gt;</span> 销售明细查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="6">销售明细查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">账单号</th>
					<th class="center">物资</th>
			...
			<c:forEach items="${detailsList}" var="details">
				<tr class="text-c">
					<td class="center">${details.sno}</td>
					<td class="center">${details.goodsname}</td>
					<td class="center">${details.price}</td>
					<td class="center">${details.num}</td>
					<td class="center">${details.total}</td>
				</tr>
			</c:forEach>
		</table>
		...
		<div class="text-c">
			<form action="details/queryDetailsByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="goodsid">按物资查询</option>
