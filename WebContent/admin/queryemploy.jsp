...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>销售经理管理 <span class="c-gray en">&gt;</span> 销售经理查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="12">销售经理查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${employList}" var="employ">
				<tr class="text-c">
					...
					<td class="center">${employ.employname}</td>
					<td class="center">${employ.sex}</td>
					<td class="center"><img alt="" src="${employ.image}" style="width: 65px; height: 65px;"></td>
					<td class="center">${employ.birthday}</td>
					<td class="center">${employ.contact}</td>
					<td class="center">${employ.address}</td>
					<td class="center">${employ.total}</td>
		...
		<div class="text-c">
			<form action="employ/queryEmployByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="employname">按姓名查询</option>
						...
						<option value="total">按总业绩查询</option>
