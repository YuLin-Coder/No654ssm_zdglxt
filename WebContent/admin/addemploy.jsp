...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>销售经理管理 <span class="c-gray en">&gt;</span> 新增销售经理 <a
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="employ/addEmploy.action" name="myform" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="address" class="input-text" id="address" placeholder="请输入联系地址" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">入职日期</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="workdate" class="input-text" id="workdate" onclick="WdatePicker()" readonly="readonly" placeholder="请输入入职日期" />
				</div>
			</div>
			<div class="row cl">
